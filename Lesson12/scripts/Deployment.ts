...
async function main(){
    ...
    console.log(`Tokenized Voes contract deployed at  ${contract.address}\n`);
    ...
    for (let blockNumber = currentBlock.number - 1; blockNumber >=0; blockNumber--) {
        ...
        console.log(`At block number ${blockNumber} the voter had ${pastVotePower} decimals vote power\n`);
